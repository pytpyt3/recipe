...
$("search_btn").on("click",function(){
	sesson.setattribute("search",$("search_txt"))
...
<body>
<input type="button" id = "home_btn" name="home_btn" value="홈버튼">
<input type="button" id = "upload_btn" name="upload_btn" value="업로드">
<input type="button" id = "bookmark_btn" name="bookmark_btn" value="즐겨찾기">
<input type="button" id = "ref_btn" name="ref_btn" value="냉장고">
<input type="button" id = "loginModal_btn" name="loginModal_btn" value="로그인모달">
<br><br><br>
<input type="text" id = "search_txt" name="search_txt" placeholder="검색어">
<input type="button" id = "search_btn" name="search_btn" value="검색">
<br><br><br>
<input type="text" id = "login_txt" name="login_txt" placeholder="아이디">
<input type="text" id = "pwd_txt" name="pwn_txt" placeholder="패스워드">
<input type="button" id = "login_btn" name="login_btn" value="로그인">
<input type="button" id = "signup_btn" name="signup_btn" value="회원가입">
